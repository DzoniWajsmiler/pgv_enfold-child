<?php
    ...
    /* added automatic redirect to custom conference page */
    $site_id = get_field('ow_konferenca_site', $post->ID);
    ...
    if(!empty($site_id)){
        ...
        /* added automatic redirect from child to parent product page! */
